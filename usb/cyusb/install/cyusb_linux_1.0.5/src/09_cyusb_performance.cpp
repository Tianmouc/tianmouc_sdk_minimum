...

{
	...
	// 	}
	// }
	// modified by Taoyi.Wang
	endpoint = 0x86;
	reqsize    = 16;	// Request size in number of packets
	queuedepth = 64;	// Number of requests to queue
	...
	// add by  Taoyi.Wang, reset the device, otherwise it would fail!
	cyusb_reset_device(dev_handle);
